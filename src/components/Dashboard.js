         ...
         <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg bg-gradient-to-r from-blue-300 to-white dark:border-gray-700">
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
              <div class="w-full md:w-1/2 max-w-md px-3 mb-6 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"  type="text" placeholder="2019" 
                  value={year1} />
              </div>
              <div class="w-full md:w-1/2 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="2020" 
