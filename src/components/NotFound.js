...
const NotFound = () => {
  return (
    <div class=" ">
      ...
      <main class="h-screen w-full flex flex-col justify-center items-center bg-gradient-to-r from-blue-300 to-white">
        <h1 class="text-12xl font-extrabold from-blue-400 via-blue-500 to-blue-600 tracking-widest">404</h1>
        <div class="bg-[#FF6A3D] px-2 text-xl rounded rotate-12 absolute">
          Page Not Found
        </div>
        <button class="mt-5">
          <a href="/Main" class="relative inline-block text-sm font-medium
             from-blue-400 via-blue-500 to-blue-600 group active:text-orange-500 focus:outline-none focus:ring">
            <span
